...
import com.example.projectapplication.CourseActivity;
...
import com.example.projectapplication.ui.announcements.AnnouncementsViewModel;
        ...
        public RecyclerViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Log.d(TAG, "onClick: starting course activity"+mCourseList.get(getAdapterPosition()).getCourse_id());
                    String courseId = mCourseList.get(getAdapterPosition()).getCourse_id();
                    Intent intent = new Intent(mContext, CourseActivity.class);
                    intent.putExtra(mContext.getString(R.string.intent_course),courseId);
